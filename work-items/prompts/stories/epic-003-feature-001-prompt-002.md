...
## Required Changes
1. Implement Retrieval (Read-only) — Authorization enforcement — operational evidence path.
...
Implement Retrieval (Read-only) — Authorization enforcement — operational evidence path.
Context: enforce retrieval (read-only) — authorization enforcement for the operational evidence path.

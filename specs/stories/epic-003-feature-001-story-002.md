...
## User Story
As a system, I must perform enforce retrieval (read-only) — authorization enforcement for the operational evidence path so that governance requirements are satisfied.
